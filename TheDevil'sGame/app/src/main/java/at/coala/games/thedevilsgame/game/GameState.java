 ...
 *
 * Abstract class providing an environment for subclasses to supply different actions for different states. Simply override the methods to to change the functionality.
 */
